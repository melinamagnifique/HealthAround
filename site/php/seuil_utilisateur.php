...
<body class="u-body u-xl-mode">
  ...
  <center>
        <div class="admin-section">
            <h2>Bienvenue sur la page des seuils de capteurs</h2>
            <h3>Retrouvez toutes les infos des mesures enregistrées par nos capteurs</h3>
    </center>
  <center><h4>Voici les seuils des différents capteurs</h4></center>

  <?php
  // Tableau de types de capteurs
  $capteurs = array(
    array('type' => 'Capteur cardiaque', 'seuil' => 100),
    array('type' => 'Capteur d\'humidité', 'seuil' => 50),
    array('type' => 'Capteur de son', 'seuil' => 80),
    array('type' => 'Capteur de CO2', 'seuil' => 500)
  );
