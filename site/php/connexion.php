        ...
        if ($user) {
            if (password_verify($password, $user['password'])) {
                ...
                if ($email == "admin@gmail.com") {
                    ...
                    header('Location: ../php/accueil_utilisateur.php');
                    exit();
                }
            } else {
            ...
            <div class="u-layout-row">
              <div class="u-align-left u-container-style u-layout-cell u-size-30 u-white u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <h2 class="u-subtitle u-text u-text-1">Pas inscrit ?</h2>
                  <p class="u-text u-text-default u-text-2">Veuillez créer un compte puis réessayez. Votre compte est protégé par un mot de passe, tâchez de vous en souvenir ou cliquez sur "<a href="../php/Contact.php" data-page-id="69552326">mot de passe oublié</a>".</p>
                  <div class="u-align-left u-form u-form-1">
                    <form action="#" class="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form" style="padding: 0px;" source="email" name="form" data-services="0e76378efb12818c85145cf1e23072c5">
                      <div class="u-align-left u-form-group u-form-group-1">
                        <a href="../php/inscription.php" class="u-active-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-gradient u-hover-black u-none u-radius-50 u-btn-1">Créer un compte<br>
                        </a>
                      </div>
                    </form>
                  </div>
              ...
              <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-subtitle u-text u-text-3">S'identifier</h2>
    ...
    <div class="form-box">
        <div class="form-value">
            <form id="formulaire" method="POST">
                ...
                <div class="register">
                <input type="submit" value="Se connecter" id="formsend" name="formsend" class="u-active-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-gradient u-hover-black u-none u-radius-50 u-btn-1">
                <div id="password-error">
                    <p id="password-error-text"></p>
                </div>
                <center>
                    <p>Vous n'avez pas encore de compte ? <br><a href="../php/inscription.php">Créer un compte</a></p>
                </div>
                </center>
            </form>
...
"></path></svg></span>
    ...
    <p>&copy; 2023 G10A. Tous droits réservés.</p>
  </div>
</div>
</div>
</div>
...
<script src="../js/jG10A.js"></script>
<script src="../js/j2G10A.js"></script>
</body>
</html>