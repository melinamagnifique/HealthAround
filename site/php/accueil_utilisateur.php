...
<body class="u-body u-xl-mode">
    ...
    <h1>Retrouvez toutes les infos des capteurs en temps réel</h1>
    </div>
    <div><br></div>
    <div><br></div>
    ...
    <p>700 ppm (Tout est dans les normes !)</p>
    <div class="title-capteurs">
    <h2>Capteur Sonore</h2>
    </div>
    <p>80 dB (Tout est dans les normes !)</p>
    
    <div class="title-capteurs">
    <h2>Capteur Cardiaque</h2>
    </div>
    <p>60 bpm (Tout est dans les normes !)</p>
    
    <div class="title-capteurs">
    <h2>Capteur Humidité et température</h2>
    </div>
    <p>27 °C (Il fait un peu chaud par ici !)</p>
