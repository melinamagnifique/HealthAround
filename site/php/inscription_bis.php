...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-white" href="../php/capteurs.php">Les capteurs</a></li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="../php/quiz.php">Quiz</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="../php/capteurs.php">Les capteurs</a></li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="../php/quiz.php">Quiz</a>
    ...
    <div class="form-box">
        <div class="form-value">
            <form id="formulaire" method="POST">
                ...
                <label for="accept_conditions"> J'accepte les <a href="../php/CGU.php" target="_blank">conditions générales d'utilisation</a></label>
  ...
  document.getElementById("formulaire").addEventListener("submit", function(event) {
    ...
    request.onload = function() {
      if (request.status === 200) {
        // Succès de l'enregistrement des données
